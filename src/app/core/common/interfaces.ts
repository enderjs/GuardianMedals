...
export interface IDestinyHistoricalStatsDefinition {
    [key: string]: IDestinyHistoricalStatsDefinitionValue;
}

export interface IDestinyHistoricalStatsDefinitionValue {
    statId: string;
    group: DestinyStatsGroupType;
    periodTypes: PeriodType[];
    modes: DestinyActivityModeType[];
...
// /**
//  * Interface for the response of SearchDestinyPlayer
//  * @interface
//  */
// export interface ISearchDestinyPlayer {
//     iconPath: string;
//     ieMembershipType;
//     membershipId: string;
//     displayName: string;
